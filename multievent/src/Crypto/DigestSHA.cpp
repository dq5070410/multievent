...
ME_Result CMEDigestSHA::SetOption(
    DWORD dwOptionType,
    void* pOptionValue )
{
...
ME_Result CMEDigestSHA::GetOption(
    DWORD dwOptionType,
    void*& pOptionValue )
{
    return ME_ERROR_NOT_AVAILABLE;
...
ME_Result CMEDigestSHA::GetDigest(
    DWORD dwMode,
    const EVP_MD*& pDigest )
{
    switch ( dwMode )
