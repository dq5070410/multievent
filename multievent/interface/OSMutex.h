...
*/
ME_Result ME_OS_EXPORT MutexDestroy( ME_MUTEX_CS& hmcLock );
...
*		ME_OK为成功；R_ERROR_TIMEOUT为超时；其他失败
*/
ME_Result ME_OS_EXPORT MutexLock( ME_MUTEX_CS& hmcLock );
...
*		ME_OK为成功；其他失败
*/
ME_Result ME_OS_EXPORT MutexUnLock( ME_MUTEX_CS& hmcLock );
